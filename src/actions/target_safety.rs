//! Extra mutation-time identity checks for process/service/task targets.
//!
//! The matching layer classifies semantic ownership, but destructive process
//! termination also verifies the live process image through the SAME handle
//! that will be used to terminate it. This closes basename false positives and
//! the PID-reuse gap between a Toolhelp snapshot and OpenProcess.
...
fn open_and_verify(pid: u32, rights: u32, expected_exe_name: &str) -> Result<(ProcessHandle, String), String> {
